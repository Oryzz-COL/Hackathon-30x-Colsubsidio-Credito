...
export const CONNECTORS = [
  ...
  { id: "life-events-demo", name: "Eventos de vida · demo", description: "Hitos sintéticos declarados por la persona", enabled: true, legalBasis: "Consentimiento por finalidad", consentRequired: true, fieldsProvided: ["Evento","Fecha","Vigencia"], rateLimit: "6 perfiles sintéticos", healthStatus: "SIMULADO" },
  { id: "public-context", name: "Contexto público", description: "Calendarios académicos, tributarios y legales", enabled: true, legalBasis: "Fuente pública oficial no personal", consentRequired: false, fieldsProvided: ["Ventana","Ciudad","Momento"], rateLimit: "Calendario versionado", healthStatus: "OPERATIVO" },
  { id: "open-finance-demo", name: "Open finance · demo", description: "Obligaciones sintéticas con autorización expresa", enabled: true, legalBasis: "Autorización financiera sintética", consentRequired: true, fieldsProvided: ["Obligaciones declaradas"], rateLimit: "Solo caso sintético autorizado", healthStatus: "SIMULADO" },
